package com.game.wegame.server;
...
public class GameServer {
    ...
    private static final Map<GameServer, String>
            connections = new ConcurrentHashMap<GameServer, String>();
    ...
    private void broadcast(String msg) {
        ...
        Iterator<GameServer> iterator = connections.keySet().iterator();
        while (iterator.hasNext()) {
            GameServer client = iterator.next();
            synchronized (client) {
